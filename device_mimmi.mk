...
# mimmi specific gps.conf
PRODUCT_COPY_FILES += \
    device/semc/mimmi/prebuilt/gps.conf:system/etc/gps.conf
...
PRODUCT_COPY_FILES += \
    device/semc/mimmi/media_profiles.xml:/system/etc/media_profiles.xml
...
PRODUCT_COPY_FILES += \
    device/semc/mimmi/placeholder:system/sd/placeholder
...
PRODUCT_COPY_FILES += \
    device/semc/mimmi/prebuilt/a2sd:system/bin/a2sd \
